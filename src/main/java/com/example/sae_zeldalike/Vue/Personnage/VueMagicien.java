...
public class VueMagicien extends VuePersonnage{
    ...
    public VueMagicien(Pane pane, Personnage personnage) {
    ...
    private void initialiser(){
        spritePerso1 = new Image("file:src/main/resources/com/example/sae_zeldalike/Personnage/Magicien/Magicien.png");
        spritePerso2 = new Image("file:src/main/resources/com/example/sae_zeldalike/Personnage/Magicien/Magicien.png");
        spritePerso3 = new Image("file:src/main/resources/com/example/sae_zeldalike/Personnage/Magicien/Magicien.png");
    }
